...
export const SLight = styled.div``;
...
export const SHeader__user = styled(S_hover02)`
  height: 20px;
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
export const SHeader__popUserSet = styled.div`
  display: ${({ $type }) => ($type === true ? "block" : "none")};
  position: absolute;
  top: 61px;
  right: 0;
  width: 213px;
...
export const SPopUserSet = styled(STarget)`
  button {
    width: 72px;
    height: 30px;
...
export const SPopUserSet__name = styled.p`
  color: #000;
  font-size: 14px;
  font-weight: 500;
  line-height: 21px;
...
export const SPopUserSet__mail = styled.p`
  color: #94a6be;
  font-size: 14px;
  line-height: 21px;
  letter-spacing: -0.14px;
...
export const SPopUserSet__theme = styled.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  margin-bottom: 30px;
